...
public class Caching {
    ...
    private static class MapCache extends StdCache {
        ...
        public StdCache dropOne(Request r) {
            _cache.remove(r);
            return this;
        }
    ...
    public static class CachedAccumFetch extends AccumOp.AccumulateAndFetch {
        @defsfn
        public Object[] __cachedAccumFetch(Cache cache, Request... requests) throws Throwable {
    ...
    public static class CachedStore {
        ...
        public Object __cachedStore(Cache cache, Request request) {
